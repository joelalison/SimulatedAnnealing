...
A figura abaixo mostra a evoluçaõ do algoritmo. É possível analisar que se a solução principal não muda de valor enquanto a solução vizinha (que faz a exploração) for maior.
